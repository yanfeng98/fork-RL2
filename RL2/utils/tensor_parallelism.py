...
def prepare_tp_model(model: PreTrainedModel, device_mesh: dist.device_mesh.DeviceMesh) -> None:
...
def prepare_llama_tp_actor(model: LlamaForCausalLM|Qwen2ForCausalLM|Qwen3ForCausalLM, device_mesh: dist.device_mesh.DeviceMesh) -> None:
...
def prepare_llama_tp_layer(layer: nn.Module, device_mesh: dist.device_mesh.DeviceMesh) -> None:
...
def prepare_llama_tp_critic(model: LlamaForTokenClassification|Qwen2ForTokenClassification|Qwen3ForTokenClassification, device_mesh: dist.device_mesh.DeviceMesh) -> None:
